...
class Save extends \Udeytech\Dubey\Controller\Adminhtml\Items
{
    public function execute()
    {
        if ($this->getRequest()->getPostValue()) {
            try {
                $model = $this->_objectManager->create('Udeytech\Dubey\Model\Dubey');
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('udeytech_dubey/*/edit', ['id' => $model->getId()]);
                    return;
                }
                $this->_redirect('udeytech_dubey/*/');
                return;
            } catch (\Magento\Framework\Exception\LocalizedException $e) {
                $this->messageManager->addError($e->getMessage());
                $id = (int)$this->getRequest()->getParam('id');
                if (!empty($id)) {
                    $this->_redirect('udeytech_dubey/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('udeytech_dubey/*/new');
                }
                return;
            } catch (\Exception $e) {
                ...
                $this->_redirect('udeytech_dubey/*/edit', ['id' => $this->getRequest()->getParam('id')]);
                return;
            }
        }
        $this->_redirect('udeytech_dubey/*/');
